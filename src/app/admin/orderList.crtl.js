    ...
    function addOrder(event) {
      ...
      function DialogController($scope, $mdDialog) {
        ...
        $scope.addOfflineOrder = function() {
          if ($scope.order && $scope.order.remark && $scope.order.selectedCourse && $scope.order.selectedCourse.id && $scope.order.selectedCourse.courseFee && $scope.order.selectedStudent && $scope.order.selectedStudent.id && $scope.order.pg) {
            ...
            growl.info('Please fill mandatory fields');
          }
        }
      }
    }
